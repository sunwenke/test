...
#             charset='utf8',
#             cursorclass=pymysql.cursors.DictCursor,  # 使用字典连接参数管理数据
#             use_unicode=True,
#         )
...
#         insert_sql = "insert into jobbole_article(title, url, create_date, fav_nums, tags) VALUES (%s, %s, %s, %s, %s)"
#         cursor.execute ( insert_sql,(item["title"], item["url"], item["create_date"], item["fav_nums"],item["front_image_url"],item["front_image_path"],item["fav_nums"],item["comment_nums"],item["praise_nums"],item["tags"]) )
